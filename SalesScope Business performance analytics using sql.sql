...
SELECT SUM(transactions.sales_amount) from transactions INNER JOIN date on transactions.order_date = 
date.date where date.year = 2020 and transactions.currency = "INR\r" or transactions.currency = "USD\r";
